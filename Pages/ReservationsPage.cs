...
{
    public class ReservationsPage:ViewPage<Reservation, ReservationView>
    {
        ...
        protected internal override ReservationView ToViewModel(Reservation c)
        {
        ...
        protected internal override Reservation ToEntity(ReservationView c)
        {
            if (IsNull(c)) return null;
