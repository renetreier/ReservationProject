...
namespace ReservationProject.Tests.Pages.Common
{
       ...
       where TView : IEntityData
    {
        ...
        [TestMethod] public void IsNullReturnTrue()
        {
            Assert.AreEqual(true, PageModel.IsNull(null));
        }
        [TestMethod] public void IsNullReturnFalse()
        {
            Assert.AreEqual(false, PageModel.IsNull(1));
        }
        [TestMethod] public void ToViewModelTestItemIsNull()
        {
        ...
        [TestMethod] public void OnPostDeleteGetRedirected()
        {
